    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            for (int j = 0; j <n/2; j++) {
                ...
                char c1Prev = (c1 == 'a') ? 'b' : (char)(c1 - 1);
                char c1Next = (c1 == 'z') ? 'y' : (char)(c1 + 1);
                char c2Prev = (c2 == 'a') ? 'b' : (char)(c2 - 1);
                char c2Next = (c2 == 'z') ? 'y' : (char)(c2 + 1);
                if (c1Prev != c2Prev && c1Prev != c2Next && c1Next != c2Prev && c1Next != c2Next) {
                    possible = false;
                    break;
                }
            }
